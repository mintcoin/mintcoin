#############################################################################
# Makefile for building: mintcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sun Dec 22 21:54:19 2013
# Project:  mintcoin-qt.pro
# Template: app
# Command: /usr/bin/qmake-qt4 USE_UPNP=- USE_IPV6=- -o Makefile mintcoin-qt.pro
#############################################################################
...
SOURCES       = src/qt/mintcoin.cpp \
		src/qt/mintcoingui.cpp \
		...
		src/noui.cpp build/moc_mintcoingui.cpp \
		...
		build/moc_mintcoinaddressvalidator.cpp \
		...
		build/moc_mintcoinamountfield.cpp \
...
OBJECTS       = build/mintcoin.o \
		...
		build/mintcoinaddressvalidator.o \
		build/version.o \
		build/sync.o \
		build/util.o \
		build/netbase.o \
		...
		build/mintcoinstrings.o \
		build/mintcoinamountfield.o \
		build/wallet.o \
		build/keystore.o \
		...
		build/moc_mintcoinaddressvalidator.o \
		...
		build/moc_mintcoinamountfield.o \
...
Makefile: mintcoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_UPNP=- USE_IPV6=- -o Makefile mintcoin-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/mintcoin-qt0.6.3 || $(MKDIR) build/mintcoin-qt0.6.3 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/mintcoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/locale/mintcoin_bg.ts src/qt/locale/mintcoin_ca_ES.ts src/qt/locale/mintcoin_cs.ts src/qt/locale/mintcoin_da.ts src/qt/locale/mintcoin_de.ts src/qt/locale/mintcoin_el_GR.ts src/qt/locale/mintcoin_en.ts src/qt/locale/mintcoin_es.ts src/qt/locale/mintcoin_es_CL.ts src/qt/locale/mintcoin_et.ts src/qt/locale/mintcoin_eu_ES.ts src/qt/locale/mintcoin_fa.ts src/qt/locale/mintcoin_fa_IR.ts src/qt/locale/mintcoin_fi.ts src/qt/locale/mintcoin_fr.ts src/qt/locale/mintcoin_fr_CA.ts src/qt/locale/mintcoin_he.ts src/qt/locale/mintcoin_hr.ts src/qt/locale/mintcoin_hu.ts src/qt/locale/mintcoin_it.ts src/qt/locale/mintcoin_lt.ts src/qt/locale/mintcoin_nb.ts src/qt/locale/mintcoin_nl.ts src/qt/locale/mintcoin_pl.ts src/qt/locale/mintcoin_pt_BR.ts src/qt/locale/mintcoin_pt_PT.ts src/qt/locale/mintcoin_ro_RO.ts src/qt/locale/mintcoin_ru.ts src/qt/locale/mintcoin_sk.ts src/qt/locale/mintcoin_sr.ts src/qt/locale/mintcoin_sv.ts src/qt/locale/mintcoin_tr.ts src/qt/locale/mintcoin_uk.ts src/qt/locale/mintcoin_zh_CN.ts src/qt/locale/mintcoin_zh_TW.ts build/mintcoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/mintcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/mintcoinaddressvalidator.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/sync.h src/util.h src/uint256.h src/serialize.h src/strlcpy.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/irc.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/mintcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/mintcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/mintcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/scrypt.h src/qt/miningpage.h src/version.h src/qt/rpcconsole.h build/mintcoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/mintcoin.qrc build/mintcoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/mintcoin.cpp src/qt/mintcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/mintcoinaddressvalidator.cpp src/version.cpp src/sync.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/irc.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/json/json_spirit_writer.cpp src/json/json_spirit_value.cpp src/json/json_spirit_reader.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/mintcoinstrings.cpp src/qt/mintcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/mintcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/mintcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/scrypt.c src/qt/miningpage.cpp src/noui.cpp build/mintcoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/miningpage.ui src/qt/forms/optionsdialog.ui build/mintcoin-qt0.6.3/ && $(COPY_FILE) --parents src/qt/locale/mintcoin_bg.ts src/qt/locale/mintcoin_ca_ES.ts src/qt/locale/mintcoin_cs.ts src/qt/locale/mintcoin_da.ts src/qt/locale/mintcoin_de.ts src/qt/locale/mintcoin_el_GR.ts src/qt/locale/mintcoin_en.ts src/qt/locale/mintcoin_es.ts src/qt/locale/mintcoin_es_CL.ts src/qt/locale/mintcoin_et.ts src/qt/locale/mintcoin_eu_ES.ts src/qt/locale/mintcoin_fa.ts src/qt/locale/mintcoin_fa_IR.ts src/qt/locale/mintcoin_fi.ts src/qt/locale/mintcoin_fr.ts src/qt/locale/mintcoin_fr_CA.ts src/qt/locale/mintcoin_he.ts src/qt/locale/mintcoin_hr.ts src/qt/locale/mintcoin_hu.ts src/qt/locale/mintcoin_it.ts src/qt/locale/mintcoin_lt.ts src/qt/locale/mintcoin_nb.ts src/qt/locale/mintcoin_nl.ts src/qt/locale/mintcoin_pl.ts src/qt/locale/mintcoin_pt_BR.ts src/qt/locale/mintcoin_pt_PT.ts src/qt/locale/mintcoin_ro_RO.ts src/qt/locale/mintcoin_ru.ts src/qt/locale/mintcoin_sk.ts src/qt/locale/mintcoin_sr.ts src/qt/locale/mintcoin_sv.ts src/qt/locale/mintcoin_tr.ts src/qt/locale/mintcoin_uk.ts src/qt/locale/mintcoin_zh_CN.ts src/qt/locale/mintcoin_zh_TW.ts build/mintcoin-qt0.6.3/ && (cd `dirname build/mintcoin-qt0.6.3` && $(TAR) mintcoin-qt0.6.3.tar mintcoin-qt0.6.3 && $(COMPRESS) mintcoin-qt0.6.3.tar) && $(MOVE) `dirname build/mintcoin-qt0.6.3`/mintcoin-qt0.6.3.tar.gz . && $(DEL_FILE) -r build/mintcoin-qt0.6.3
...
/home/og/mintcoin/build/build.h: FORCE
	cd /home/og/mintcoin; /bin/sh share/genbuild.sh /home/og/mintcoin/build/build.h
...
compiler_TSQM_make_all: src/qt/locale/mintcoin_bg.qm src/qt/locale/mintcoin_ca_ES.qm src/qt/locale/mintcoin_cs.qm src/qt/locale/mintcoin_da.qm src/qt/locale/mintcoin_de.qm src/qt/locale/mintcoin_el_GR.qm src/qt/locale/mintcoin_en.qm src/qt/locale/mintcoin_es.qm src/qt/locale/mintcoin_es_CL.qm src/qt/locale/mintcoin_et.qm src/qt/locale/mintcoin_eu_ES.qm src/qt/locale/mintcoin_fa.qm src/qt/locale/mintcoin_fa_IR.qm src/qt/locale/mintcoin_fi.qm src/qt/locale/mintcoin_fr.qm src/qt/locale/mintcoin_fr_CA.qm src/qt/locale/mintcoin_he.qm src/qt/locale/mintcoin_hr.qm src/qt/locale/mintcoin_hu.qm src/qt/locale/mintcoin_it.qm src/qt/locale/mintcoin_lt.qm src/qt/locale/mintcoin_nb.qm src/qt/locale/mintcoin_nl.qm src/qt/locale/mintcoin_pl.qm src/qt/locale/mintcoin_pt_BR.qm src/qt/locale/mintcoin_pt_PT.qm src/qt/locale/mintcoin_ro_RO.qm src/qt/locale/mintcoin_ru.qm src/qt/locale/mintcoin_sk.qm src/qt/locale/mintcoin_sr.qm src/qt/locale/mintcoin_sv.qm src/qt/locale/mintcoin_tr.qm src/qt/locale/mintcoin_uk.qm src/qt/locale/mintcoin_zh_CN.qm src/qt/locale/mintcoin_zh_TW.qm
compiler_TSQM_clean:
	-$(DEL_FILE) src/qt/locale/mintcoin_bg.qm src/qt/locale/mintcoin_ca_ES.qm src/qt/locale/mintcoin_cs.qm src/qt/locale/mintcoin_da.qm src/qt/locale/mintcoin_de.qm src/qt/locale/mintcoin_el_GR.qm src/qt/locale/mintcoin_en.qm src/qt/locale/mintcoin_es.qm src/qt/locale/mintcoin_es_CL.qm src/qt/locale/mintcoin_et.qm src/qt/locale/mintcoin_eu_ES.qm src/qt/locale/mintcoin_fa.qm src/qt/locale/mintcoin_fa_IR.qm src/qt/locale/mintcoin_fi.qm src/qt/locale/mintcoin_fr.qm src/qt/locale/mintcoin_fr_CA.qm src/qt/locale/mintcoin_he.qm src/qt/locale/mintcoin_hr.qm src/qt/locale/mintcoin_hu.qm src/qt/locale/mintcoin_it.qm src/qt/locale/mintcoin_lt.qm src/qt/locale/mintcoin_nb.qm src/qt/locale/mintcoin_nl.qm src/qt/locale/mintcoin_pl.qm src/qt/locale/mintcoin_pt_BR.qm src/qt/locale/mintcoin_pt_PT.qm src/qt/locale/mintcoin_ro_RO.qm src/qt/locale/mintcoin_ru.qm src/qt/locale/mintcoin_sk.qm src/qt/locale/mintcoin_sr.qm src/qt/locale/mintcoin_sv.qm src/qt/locale/mintcoin_tr.qm src/qt/locale/mintcoin_uk.qm src/qt/locale/mintcoin_zh_CN.qm src/qt/locale/mintcoin_zh_TW.qm
src/qt/locale/mintcoin_bg.qm: src/qt/locale/mintcoin_bg.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_bg.ts -qm src/qt/locale/mintcoin_bg.qm

src/qt/locale/mintcoin_ca_ES.qm: src/qt/locale/mintcoin_ca_ES.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_ca_ES.ts -qm src/qt/locale/mintcoin_ca_ES.qm

src/qt/locale/mintcoin_cs.qm: src/qt/locale/mintcoin_cs.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_cs.ts -qm src/qt/locale/mintcoin_cs.qm

src/qt/locale/mintcoin_da.qm: src/qt/locale/mintcoin_da.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_da.ts -qm src/qt/locale/mintcoin_da.qm

src/qt/locale/mintcoin_de.qm: src/qt/locale/mintcoin_de.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_de.ts -qm src/qt/locale/mintcoin_de.qm

src/qt/locale/mintcoin_el_GR.qm: src/qt/locale/mintcoin_el_GR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_el_GR.ts -qm src/qt/locale/mintcoin_el_GR.qm

src/qt/locale/mintcoin_en.qm: src/qt/locale/mintcoin_en.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_en.ts -qm src/qt/locale/mintcoin_en.qm

src/qt/locale/mintcoin_es.qm: src/qt/locale/mintcoin_es.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_es.ts -qm src/qt/locale/mintcoin_es.qm

src/qt/locale/mintcoin_es_CL.qm: src/qt/locale/mintcoin_es_CL.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_es_CL.ts -qm src/qt/locale/mintcoin_es_CL.qm

src/qt/locale/mintcoin_et.qm: src/qt/locale/mintcoin_et.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_et.ts -qm src/qt/locale/mintcoin_et.qm

src/qt/locale/mintcoin_eu_ES.qm: src/qt/locale/mintcoin_eu_ES.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_eu_ES.ts -qm src/qt/locale/mintcoin_eu_ES.qm

src/qt/locale/mintcoin_fa.qm: src/qt/locale/mintcoin_fa.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_fa.ts -qm src/qt/locale/mintcoin_fa.qm

src/qt/locale/mintcoin_fa_IR.qm: src/qt/locale/mintcoin_fa_IR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_fa_IR.ts -qm src/qt/locale/mintcoin_fa_IR.qm

src/qt/locale/mintcoin_fi.qm: src/qt/locale/mintcoin_fi.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_fi.ts -qm src/qt/locale/mintcoin_fi.qm

src/qt/locale/mintcoin_fr.qm: src/qt/locale/mintcoin_fr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_fr.ts -qm src/qt/locale/mintcoin_fr.qm

src/qt/locale/mintcoin_fr_CA.qm: src/qt/locale/mintcoin_fr_CA.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_fr_CA.ts -qm src/qt/locale/mintcoin_fr_CA.qm

src/qt/locale/mintcoin_he.qm: src/qt/locale/mintcoin_he.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_he.ts -qm src/qt/locale/mintcoin_he.qm

src/qt/locale/mintcoin_hr.qm: src/qt/locale/mintcoin_hr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_hr.ts -qm src/qt/locale/mintcoin_hr.qm

src/qt/locale/mintcoin_hu.qm: src/qt/locale/mintcoin_hu.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_hu.ts -qm src/qt/locale/mintcoin_hu.qm

src/qt/locale/mintcoin_it.qm: src/qt/locale/mintcoin_it.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_it.ts -qm src/qt/locale/mintcoin_it.qm

src/qt/locale/mintcoin_lt.qm: src/qt/locale/mintcoin_lt.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_lt.ts -qm src/qt/locale/mintcoin_lt.qm

src/qt/locale/mintcoin_nb.qm: src/qt/locale/mintcoin_nb.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_nb.ts -qm src/qt/locale/mintcoin_nb.qm

src/qt/locale/mintcoin_nl.qm: src/qt/locale/mintcoin_nl.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_nl.ts -qm src/qt/locale/mintcoin_nl.qm

src/qt/locale/mintcoin_pl.qm: src/qt/locale/mintcoin_pl.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_pl.ts -qm src/qt/locale/mintcoin_pl.qm

src/qt/locale/mintcoin_pt_BR.qm: src/qt/locale/mintcoin_pt_BR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_pt_BR.ts -qm src/qt/locale/mintcoin_pt_BR.qm

src/qt/locale/mintcoin_pt_PT.qm: src/qt/locale/mintcoin_pt_PT.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_pt_PT.ts -qm src/qt/locale/mintcoin_pt_PT.qm

src/qt/locale/mintcoin_ro_RO.qm: src/qt/locale/mintcoin_ro_RO.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_ro_RO.ts -qm src/qt/locale/mintcoin_ro_RO.qm

src/qt/locale/mintcoin_ru.qm: src/qt/locale/mintcoin_ru.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_ru.ts -qm src/qt/locale/mintcoin_ru.qm

src/qt/locale/mintcoin_sk.qm: src/qt/locale/mintcoin_sk.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_sk.ts -qm src/qt/locale/mintcoin_sk.qm

src/qt/locale/mintcoin_sr.qm: src/qt/locale/mintcoin_sr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_sr.ts -qm src/qt/locale/mintcoin_sr.qm

src/qt/locale/mintcoin_sv.qm: src/qt/locale/mintcoin_sv.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_sv.ts -qm src/qt/locale/mintcoin_sv.qm

src/qt/locale/mintcoin_tr.qm: src/qt/locale/mintcoin_tr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_tr.ts -qm src/qt/locale/mintcoin_tr.qm

src/qt/locale/mintcoin_uk.qm: src/qt/locale/mintcoin_uk.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_uk.ts -qm src/qt/locale/mintcoin_uk.qm

src/qt/locale/mintcoin_zh_CN.qm: src/qt/locale/mintcoin_zh_CN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_zh_CN.ts -qm src/qt/locale/mintcoin_zh_CN.qm

src/qt/locale/mintcoin_zh_TW.qm: src/qt/locale/mintcoin_zh_TW.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/mintcoin_zh_TW.ts -qm src/qt/locale/mintcoin_zh_TW.qm

compiler_moc_header_make_all: build/moc_mintcoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_mintcoinaddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_mintcoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_miningpage.cpp build/moc_rpcconsole.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_mintcoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_mintcoinaddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_mintcoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_miningpage.cpp build/moc_rpcconsole.cpp
build/moc_mintcoingui.cpp: src/qt/mintcoingui.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/mintcoingui.h -o build/moc_mintcoingui.cpp
...
build/moc_mintcoinaddressvalidator.cpp: src/qt/mintcoinaddressvalidator.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/mintcoinaddressvalidator.h -o build/moc_mintcoinaddressvalidator.cpp
...
build/moc_mintcoinamountfield.cpp: src/qt/mintcoinamountfield.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/mintcoinamountfield.h -o build/moc_mintcoinamountfield.cpp
...
compiler_rcc_make_all: qrc_mintcoin.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_mintcoin.cpp
qrc_mintcoin.cpp: src/qt/mintcoin.qrc \
		src/qt/locale/mintcoin_fa_IR.ts \
		src/qt/locale/mintcoin_hr.ts \
		src/qt/locale/mintcoin_hu.ts \
		src/qt/locale/mintcoin_zh_CN.ts \
		src/qt/locale/mintcoin_bg.ts \
		src/qt/locale/mintcoin_eu_ES.ts \
		src/qt/locale/mintcoin_fr.ts \
		src/qt/locale/mintcoin_nb.ts \
		src/qt/locale/mintcoin_tr.ts \
		src/qt/locale/mintcoin_pl.ts \
		src/qt/locale/mintcoin_ru.ts \
		src/qt/locale/mintcoin_nl.ts \
		src/qt/locale/mintcoin_uk.ts \
		src/qt/locale/mintcoin_it.ts \
		src/qt/locale/mintcoin_ca_ES.ts \
		src/qt/locale/mintcoin_ro_RO.ts \
		src/qt/locale/mintcoin_sk.ts \
		src/qt/locale/mintcoin_en.ts \
		src/qt/locale/mintcoin_el_GR.ts \
		src/qt/locale/mintcoin_es_CL.ts \
		src/qt/locale/mintcoin_he.ts \
		src/qt/locale/mintcoin_fa.ts \
		src/qt/locale/mintcoin_zh_TW.ts \
		src/qt/locale/mintcoin_es.ts \
		src/qt/locale/mintcoin_et.ts \
		src/qt/locale/mintcoin_pt_BR.ts \
		src/qt/locale/mintcoin_sr.ts \
		src/qt/locale/mintcoin_lt.ts \
		src/qt/locale/mintcoin_da.ts \
		src/qt/locale/mintcoin_cs.ts \
		src/qt/locale/mintcoin_pt_PT.ts \
		src/qt/locale/mintcoin_sv.ts \
		src/qt/locale/mintcoin_fi.ts \
		src/qt/locale/mintcoin_fr_CA.ts \
		src/qt/locale/mintcoin_de.ts \
		...
		src/qt/res/icons/mintcoin_testnet.png \
	...
	/usr/lib/x86_64-linux-gnu/qt4/bin/rcc -name mintcoin src/qt/mintcoin.qrc -o qrc_mintcoin.cpp
...
build/mintcoin.o: src/qt/mintcoin.cpp src/qt/mintcoingui.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		src/qt/optionsmodel.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/mintcoin.o src/qt/mintcoin.cpp

build/mintcoingui.o: src/qt/mintcoingui.cpp src/qt/mintcoingui.h \
		src/qt/transactiontablemodel.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/mintcoingui.o src/qt/mintcoingui.cpp
...
build/mintcoinaddressvalidator.o: src/qt/mintcoinaddressvalidator.cpp src/qt/mintcoinaddressvalidator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/mintcoinaddressvalidator.o src/qt/mintcoinaddressvalidator.cpp
...
build/mintcoinstrings.o: src/qt/mintcoinstrings.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/mintcoinstrings.o src/qt/mintcoinstrings.cpp

build/mintcoinamountfield.o: src/qt/mintcoinamountfield.cpp src/qt/mintcoinamountfield.h \
		src/qt/qvaluecombobox.h \
		src/qt/mintcoinunits.h \
		src/qt/guiconstants.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/mintcoinamountfield.o src/qt/mintcoinamountfield.cpp
...
build/mintcoinrpc.o: src/mintcoinrpc.cpp src/main.h \
		src/bignum.h \
		src/util.h \
		src/uint256.h \
		src/netbase.h \
		...
		src/json/json_spirit_writer_template.h \
		src/json/json_spirit_utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/mintcoinrpc.o src/mintcoinrpc.cpp
...
build/mintcoinunits.o: src/qt/mintcoinunits.cpp src/qt/mintcoinunits.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/mintcoinunits.o src/qt/mintcoinunits.cpp
...
build/moc_mintcoingui.o: build/moc_mintcoingui.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_mintcoingui.o build/moc_mintcoingui.cpp
...
build/moc_mintcoinaddressvalidator.o: build/moc_mintcoinaddressvalidator.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_mintcoinaddressvalidator.o build/moc_mintcoinaddressvalidator.cpp
...
build/moc_mintcoinamountfield.o: build/moc_mintcoinamountfield.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_mintcoinamountfield.o build/moc_mintcoinamountfield.cpp
...
build/qrc_mintcoin.o: qrc_mintcoin.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/qrc_mintcoin.o qrc_mintcoin.cpp
