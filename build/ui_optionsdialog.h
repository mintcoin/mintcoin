...
**
** Created: Sun Dec 22 21:54:28 2013
...
public:
    ...
    MintcoinAmountField *transactionFee;
    QSpacerItem *horizontalSpacer_Main;
    QCheckBox *mintcoinAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee = new MintcoinAmountField(tabMain);
        ...
        mintcoinAtStartup = new QCheckBox(tabMain);
        mintcoinAtStartup->setObjectName(QString::fromUtf8("mintcoinAtStartup"));

        verticalLayout_Main->addWidget(mintcoinAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        mintcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start MintCoin after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mintcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start MintCoin on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the MintCoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the MintCoin network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting MintCoin.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show MintCoin addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
