...
static const CMintcoinAddress addr1 ("LWaFezDtucfCA4xcVEfs3R3xfgGWjSwcZr");
static const CMintcoinAddress addr2 ("LXwHM6mRd432EzLJYwuKQMPhTzrgr7ur9K");
static const CMintcoinAddress addr1C("LZWK8h7C166niP6GmpUmiGrvn4oxPqQgFV");
static const CMintcoinAddress addr2C("Lgb6tdqmdW3n5E12johSuEAqRMt4kAr7yu");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CMintcoinAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
{
    CMintcoinSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
