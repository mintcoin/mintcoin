...
static const char *strDNSSeed[][2] = {
    // {"mintcoinpool.org", "dnsseed.mintcoinpool.org"},
...
void StartNode(void* parg)
{
    ...
    GenerateMintcoins(GetBoolArg("-gen", false), pwalletMain);
}
...
bool StopNode()
{
    ...
    if (vnThreadsRunning[THREAD_MINER] > 0) printf("ThreadMintcoinMiner still running\n");
