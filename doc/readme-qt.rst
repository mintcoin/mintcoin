...
- Open the mintcoin-qt.pro file in Qt Creator and build as normal (ctrl-B)

.. _`Qt Windows SDK`: http://qt.nokia.com/downloads/sdk-windows-cpp
.. _`dependencies archive`: https://download.visucore.com/mintcoin/qtgui_deps_1.zip
.. [#] PGP signature: https://download.visucore.com/mintcoin/qtgui_deps_1.zip.sig (signed with RSA key ID `610945D0`_)
...
- Open the mintcoin-qt.pro file in Qt Creator and build as normal (cmd-B)
